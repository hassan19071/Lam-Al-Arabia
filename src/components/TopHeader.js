            ...
            <div className='container'>
                <div className='infos-content d-flex align-items-center justify-content-between'>
                    ...
                    <div className='social-icons d-flex align-items-center'>
                        <div className='insta'>
                            <Link target='_blank' to="https://www.instagram.com/lam_customers?igsh=Z243eXA1bDg5dXl5"><i className="fa-brands fa-instagram"></i></Link>
                        </div>
                        <div className='linkedin mx-3'>
                            <Link target='_blank' to="http://www.linkedin.com/in/advertising-services-73b935355"><i className="fa-brands fa-linkedin-in"></i></Link>
                        </div>
                        <div className='x'>
                            <Link target='_blank' to="https://x.com/lam_customers?t=v7s27b6qztSJG547PhYwEg&s=09"><i className="fa-brands fa-x"></i></Link>
                        </div>
                    </div>
                </div>
            </div>
