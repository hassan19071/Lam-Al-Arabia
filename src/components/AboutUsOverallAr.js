        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 mt-lg-0 mt-4">
            <div className="about-us-text">
              ...
              <p className="mt-3">
                لام العربية للاستشارات المهنية هي شركة استشارية رائدة تقدم حلولًا
        ...
        <section className="company-grid mt-5">
          <article className="company-feature d-flex">
            <div className="icon ms-3">
              <img
                src={MissionIcon}
                alt="رسالة لام العربية للاستشارات المهنية"
              />
            </div>
            <div className="text">
              <h3>رسالتنا</h3>
          ...
          <article className="company-feature d-flex">
            <div className="icon ms-3">
              <img
                src={VisionIcon}
                alt="رؤية لام العربية للاستشارات المهنية"
              />
            </div>
            <div className="text">
              <h3>رؤيتنا</h3>
          ...
          <article className="company-feature d-flex">
            ...
            <div className="text">
              <h3>قيمنا</h3>
              <p>
                في لام العربية للاستشارات المهنية، نحن نقدر النزاهة، والتميز، والابتكار،
          ...
          <article className="company-feature d-flex">
            <div className="icon ms-3">
              <img
                src={ExpertiseIcon}
                alt="خبرات لام العربية للاستشارات المهنية"
              />
            </div>
            <div className="text">
              <h3>خبراتنا</h3>
              <p>
                تشمل خبرات لام العربية للاستشارات المهنية التخطيط الاستراتيجي، وتطوير
          ...
          <article className="company-feature d-flex">
            <div className="icon ms-3">
              <img
                src={ApprochIcon}
                alt="نهج لام العربية للاستشارات المهنية"
              />
            </div>
            <div className="text">
              <h3>نهجنا</h3>
