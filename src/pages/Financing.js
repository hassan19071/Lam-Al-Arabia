    ...
    <>
      ...
      <Suspense fallback={<Loading/>}>
        ...
        <div className="container mx-auto px-lg-5 py-5 service-details">
          ...
          <p className="mb-6">
            Our financing services help construction companies and businesses
            secure the funding they need for project execution and growth. We
            provide end-to-end support, offering tailored financial solutions
            that meet your specific requirements and improve your cash flow.
          </p>
          <h3>Our Comprehensive Services</h3>
          <ul className="space-y-4 list-disc pl-5">
            <li>
              <strong>Funding Assessment:</strong> Evaluating your business’s
              financial needs to recommend the best financing options.
            </li>
            <li>
              <strong>Loan Application Support:</strong> Assisting with the
              preparation and submission of loan applications to financial
              institutions.
            </li>
            <li>
              <strong>Financial Planning and Strategy:</strong> Providing expert
              guidance on managing funds, optimizing cash flow, and minimizing
              financial risks.
            </li>
            <li>
            ...
            <li>
              <strong>Ongoing Financial Monitoring:</strong> Offering periodic
              reviews and reports to ensure the efficient use of funds and
          ...
          <div className="mt-8">
            ...
            <p className="mt-2">
              Our experienced team is committed to helping you secure the right
              financing with minimal hassle. We work closely with you to ensure
              your funding needs are met, enabling you to focus on growing your
              business and completing your projects successfully.
            </p>
          </div>

          <div className="mt-6">
            <p className="font-semibold">
              Contact us today to learn more about how our financing services
